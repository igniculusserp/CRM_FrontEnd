...
export default function SiteVisitByCampaign() {
  ...
  return (
    <div className="flex h-full flex-col gap-8 rounded-md border bg-white p-2 shadow-sm">
      {/* --------------------------------------- Heading --------------------------------- */}
      <Box className="relative flex w-full gap-3 rounded-md bg-white p-3">
        {["Total Site Visit - 3"].map((button) => (
          <>
            <Box
              key={button}
      ...
      {count === 0 ? (
        <>
          {/* ------------------------------------------ No Data to Display Screen ------------------------------------ */}
          <Box className="flex h-72 w-full items-center justify-center">
