        ...
        <Box className="mt-5 flex justify-center">
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={leadsData} barSize={20}>
              ...
              <Bar dataKey="Untouched" fill="#4F46E5" radius={[10, 10, 0, 0]} />
              <Bar dataKey="Touched" fill="#06B6D4" radius={[10, 10, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </Box>
      </Paper>
...
export default LeadTouchedUntouched;
