...
export default function BookingSection() {
  ...
  return (
    <div className="flex h-full flex-col gap-8 bg-gray-200">
      ...
      {/* ----------------------------------------- Buttons --------------------------------- */}
      <Box className=" justify-between gap-5 grid grid-cols-1 md:grid-cols-2">
        {/* Columns Button */}
        <div className="flex w-full gap-3 md:w-auto">
          {/* All Leads */}
          <Select
            value="Leads"
            className="w-full md:w-fit !rounded-md !bg-white !shadow-md"
            sx={{ height: 42 }}
          >
            <MenuItem value="Leads">All Bookings</MenuItem>
