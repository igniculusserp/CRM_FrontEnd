...
export default function Services() {
  ...
  const columns = [
    { field: "project", headerName: "Project", minWidth: 150, flex: 1 },
    { field: "Developer", headerName: "Developer", minWidth: 150, flex: 1 },
    { field: "towers", headerName: "No Of Towers", minWidth: 150, flex: 1 },
    { field: "Active", headerName: "Active", minWidth: 150, flex: 1 },
    { field: "Inventory", headerName: "Inventory", minWidth: 150, flex: 1 },
    { field: "Created_on", headerName: "Created on", minWidth: 150, flex: 1 },
    {
      field: "Integrated_Portals",
      headerName: "Integrated Portals",
      minWidth: 150,
      flex: 1,
    },
    {
      ...
      <Box className="flex flex-wrap justify-between gap-5">
        ...
        <div className="flex w-full flex-wrap justify-start gap-3 md:w-auto">
          ...
          <button className="flex w-full items-center justify-center gap-2 rounded-md border border-cyan-500 bg-white px-4 py-2 text-cyan-500 shadow-md hover:bg-cyan-50 md:w-auto">
            ...
            <span>Bulk Modify Projects</span>
          </button>
