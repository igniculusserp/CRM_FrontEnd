                ...
                {messages.map((msg, index) => {
                  ...
                  return (
                    ...
                    >
                      {isCurrentUser ? (
                        <>
                          <div className="relative ml-2 flex flex-col items-center rounded-lg bg-gray-200 p-2 shadow">
                            <div className="relative ml-2 flex items-center rounded-lg bg-gray-200 p-2 shadow">
                              <p className="mr-2">{msg.messageContent}</p>
                              <LongMenu />
                            </div>
