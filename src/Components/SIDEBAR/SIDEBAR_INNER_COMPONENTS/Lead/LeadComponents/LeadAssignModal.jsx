      ...
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end mt-4 gap-4">
            <button
              type="submit"
              className={`px-12 py-4 mb-3 bg-cyan-500 text-white border-2 border-cyan-500 rounded hover:text-cyan-500 hover:bg-white ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
              disabled={loading}
            >
