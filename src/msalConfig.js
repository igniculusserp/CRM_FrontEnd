...
const msalConfig = {
  auth: {
    ...
    authority:
      "https://login.microsoftonline.com/d890b36f-e465-4f18-895f-27f05789df8f", // Replace with your Directory (tenant) ID
...
// Ensure that handleRedirectPromise is only used when necessary
